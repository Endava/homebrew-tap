...
class Cats < Formula
  ...
  homepage ""
  url "https://github.com/Endava/cats/releases/download/cats-8.6.1/cats_macos_amd64_8.6.1.tar.gz"
  sha256 "b6f4c5679ff700623881380595fe3093d1c82629820b9272357423612637023b"
  license "Apache-2.0"
