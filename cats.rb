...
class Cats < Formula
  ...
  homepage ""
  url "https://github.com/Endava/cats/releases/download/cats-8.6.2/cats_macos_amd64_8.6.2.tar.gz"
  sha256 "1a6a552bc04bc2f8dffec3b99147f4ad31f5763228ae45a325242660501807c3"
  license "Apache-2.0"
